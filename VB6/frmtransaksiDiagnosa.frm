...
Begin VB.Form frmtransaksiDiagnosa 
   Caption         =   ".: Transaksi Diagnosa"
   ClientHeight    =   9240
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   17670
   ...
   Begin VSFlex8LCtl.VSFlexGrid grid 
      ...
      FormatString    =   $"frmtransaksiDiagnosa.frx":0000
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "frmtransaksiDiagnosa"
...
Private Sub LoadData()
           ...
           ReadRs "SELECT " & _
                  ...
                  "namaDokter, " & _
                  "namaUserPegawai " & _
                  "From riwayattransaksidiagnosa_v " & _
                  "where nRegistrasi like '%" & dcNRegistrasi.Text & "%' " & _
                  "and nRm ='" & txtNRm.Text & "'" & _
                  "and nRuangan like '%" & dcRuangan.BoundText & "%'"
           
           Call isiGrid("frmtransaksiDiagnosa", grid, rs, "nRegistrasi=1500,tglDiagnosa=1500,namaJenisDiagnosa=3000," & _
                        "namaDiagnosa=3800,Ruangan=1500,namaDokter=1500,namaUserPegawai=1500")
...
Private Sub dcNRegistrasi_Change()
    If dcNRegistrasi.Text <> "" Then
        ...
        End If
        Call loadDataCombo(dcRuangan, rs, "SELECT nRuangan,namaRuangan From riwayattransaksidiagnosa_v " & _
...
Private Sub txtNRm_Change()
    ...
    Call loadDataCombo(dcNRegistrasi, rs, "select distinct nRegistrasi,nRegistrasi from riwayattransaksidiagnosa_v where nRM ='" & txtNRm.Text & "'")
