...
Begin VB.Form frmInputTransaksiPelayanan 
   ...
   Begin VSFlex8LCtl.VSFlexGrid grid 
      ...
      FormatString    =   $"frmInputTransaksiPelayanan.frx":0000
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
      ...
      AccessibleRole  =   24
   End
   Begin MSDataListLib.DataCombo dcNamaTindakan 
      Height          =   405
      Left            =   240
      TabIndex        =   16
      Top             =   2520
   ...
   End
End
Attribute VB_Name = "frmInputTransaksiPelayanan"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub loadCombo()
    Call loadDataCombo(dcNamaTindakan, rs, "SELECT nTindakan,namaTindakan FROM  tindakanpelayanan where visible=1")
...
Private Sub Form_Load()
    ...
    grid.Rows = 1
    Set rs = Nothing
    Const setColumn = "nTindakan=1700,NamaTindakan=3500,nKelas=0,Kelas=2000,Tarif=2000," & _
                      "Jumlah=1500,Total=2500"
    Call captionGrid("frmInputTransaksiPelayanan", grid, 7, setColumn)
End Sub
...
Dim baris As Integer
     ...
     grid.TextMatrix(baris, 1) = dcNamaTindakan.BoundText
     grid.TextMatrix(baris, 2) = dcNamaTindakan.Text
     grid.TextMatrix(baris, 3) = dcKelas.BoundText
     grid.TextMatrix(baris, 4) = dcKelas.Text
     grid.TextMatrix(baris, 5) = txtTarif.Text
     grid.TextMatrix(baris, 6) = txtJml.Text
     grid.TextMatrix(baris, 7) = txtTotal.Text
     
     txtSubTotal.Text = 0
     For i = 1 To baris
        txtSubTotal.Text = Val(txtSubTotal.Text) + grid.TextMatrix(i, 7)
     Next
End Sub
...
Dim objSave As String
    ...
    WriteRs "insert into transaksipelayanan (nRm,nRegistrasi,tglTransaksi,nRuangan,nTindakan,hargaSatuan," & _
            "jmlPelayanan,nKelas,totalBiaya,totalAdmin,totalDiskon,totalPpn,nDokter,nPerawat,nUser) " & _
            "values " & _
            objSave
