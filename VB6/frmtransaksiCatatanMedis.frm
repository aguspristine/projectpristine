...
Begin VB.Form frmtransaksiCatatanMedis 
   Caption         =   ".: Transaksi Catatan Medis"
   ClientHeight    =   9240
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   17670
   ...
   Begin VSFlex8LCtl.VSFlexGrid grid 
      ...
      FormatString    =   $"frmtransaksiCatatanMedis.frx":0000
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "frmtransaksiCatatanMedis"
...
Private Sub LoadData()
           ...
           ReadRs "SELECT " & _
                  ...
                  "namaPerawat, " & _
                  "namaUserPegawai " & _
                  "From riwayatTransCatatanMedis_V " & _
                  "where nRegistrasi like '%" & dcNRegistrasi.Text & "%' " & _
                  "and nRm ='" & txtNRm.Text & "'" & _
                  "and nRuangan like '%" & dcRuangan.BoundText & "%'"
           
           Call isiGrid("frmtransaksiCatatanMedis", grid, rs, "nRegistrasi=1500,nRm=1500,tglCatanMedis=1500, " & _
                        "Ruangan=1500,BB=1000,tb=1000,DenyutNadi=1000,Suhu=1000,  " & _
                        "namaPerawat=3800,namaUserPegawai=1500")
...
Private Sub dcNRegistrasi_Change()
    If dcNRegistrasi.Text <> "" Then
        ...
        End If
        Call loadDataCombo(dcRuangan, rs, "SELECT nRuangan,namaRuangan From riwayatTransCatatanMedis_V " & _
...
Private Sub txtNRm_Change()
    ...
    Call loadDataCombo(dcNRegistrasi, rs, "select distinct nRegistrasi,nRegistrasi from riwayatTransCatatanMedis_V where nRM ='" & txtNRm.Text & "'")
